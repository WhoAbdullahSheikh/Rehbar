...
<body>
    <header>
        ...
        <div class="heading">
            <ul>
                ...
                <li><a href="./screens/loginscreen.php" class="under">LOGIN/REGISTER</a></li>
    ...
    <section>
        ...
        <div class="section2">
            <div class="container">
                <div class="circle-card" onclick="toggleCategory('hotel')">
                    <div class="circle-image">
                        <img src="./images/hotell.jpeg" alt="" />
                        <br />
                        <br />
                        <p>Hotels</p>
                    </div>
                </div>
                <div class="circle-card" onclick="toggleCategory('restaurant')">
                    <div class="circle-image">
                ...
                <div class="circle-card" onclick="toggleCategory('transport')">
                    <div class="circle-image">
                        <img src="./images/transport.jpeg" alt="" />
                        <br />
                        <br />
                        <p>Transport</p>
                    </div>
                </div>
                <div class="circle-card" onclick="toggleCategory('tourguide')">
                    <div class="circle-image">
        ...
        <div id="hotel" style="display: none" class="container animated-container">
            ...
            <div class="section2">
                <div class="display-image">
                    ...
                    $result = $conn->query("SELECT * FROM Hotel"); // Only select approved products
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            echo '<div class="product-card">';
                            echo '<img class="product-image" src="./screens/image/' . htmlspecialchars($row['filename']) . '" alt="' . '">';
                            echo '<div class="product-info">';
                            echo '<p>' . htmlspecialchars($row['name']) . '</p>';
                            echo '</div>';
                            echo '<div class="section-break-2"> <hr/></div>';
                            echo '<div class="product-desc"><strong>' . htmlspecialchars($row['location']) . '</div>';
                            echo '<div class="price-cart-container">';

                            echo '<p class="product-price">Rs. ' . htmlspecialchars($row['price']) . ' (Per Room)</p>';
                            echo '</div>';
        ...
        <div id="restaurant" style="display: none" class="container animated-container">
            <div class="section-break">
                <hr />
            </div>
            ...
            <div class="section2">
                <div class="display-image">
                    <?php
                    $conn = new mysqli($servername, $username, $password, $dbname); // Assume $conn is your active database connection
                    $result = $conn->query("SELECT * FROM restaurant"); // Only select approved products
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            echo '<div class="product-card">';
                            echo '<img class="product-image" src="./screens/image/' . htmlspecialchars($row['filename']) . '" alt="' . '">';
                            echo '<div class="product-info">';
                            echo '<p>' . htmlspecialchars($row['restaurant']) . '</p>';

                            echo '</div>';
                            echo '<div class="section-break-2"> <hr/></div>';
                            echo '<p class="product-desc"<strong>>Email: ' . htmlspecialchars($row['email']) . '</p>';
                            echo '<p class="product-desc">Location: ' . htmlspecialchars($row['location']) . '</p>';
                            echo '</div>'; // Close product-card
                        }
                    } else {
        ...
        <div id="transport" style="display: none" class="container animated-container">
            <div class="section-break">
                <hr />
            </div>
            ...
            <div class="section2">
                <div class="display-image">
                    <?php
                    $conn = new mysqli($servername, $username, $password, $dbname); // Assume $conn is your active database connection
                    $result = $conn->query("SELECT * FROM transport"); // Only select approved products
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            echo '<div class="product-card">';
                            echo '<img class="product-image" src="./screens/image/' . htmlspecialchars($row['filename']) . '" alt="' . '">';
                            echo '<div class="product-info">';
                            echo '<p>' . htmlspecialchars($row['transport']) . '</p>';

                            echo '</div>';
                            echo '<div class="section-break-2"> <hr/></div>';
                            echo '<p class="product-desc"><strong>Email: ' . htmlspecialchars($row['email']) . '</p>';
                            echo '<p class="product-desc">Service Type: ' . htmlspecialchars($row['service_type']) . '</p>';
                            echo '<p class="product-desc">Location: ' . htmlspecialchars($row['location']) . '</p>';

                            echo '</div>'; // Close product-card
                        }
                    } else {
                        echo "<p>No Transport found.</p>";
                    }
                    $conn->close();
                    ?>
                </div>
        ...
        <div id="tourguide" style="display: none" class="container animated-container">
            <div class="section-break">
                <hr />
            </div>
            ...
            <div class="section2">
                <div class="display-image">
                    <?php
                    $conn = new mysqli($servername, $username, $password, $dbname); // Assume $conn is your active database connection
                    $result = $conn->query("SELECT * FROM tourguide"); // Only select approved products
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            echo '<div class="product-card">';
                            echo '<img class="product-image" src="./screens/image/' . htmlspecialchars($row['filename']) . '" alt="' . '">';
                            ...
                            echo '</div>';
                            echo '<div class="section-break-2"> <hr/></div>';
                            echo '<p class="product-desc"><strong>Email: ' . htmlspecialchars($row['guide_mail']) . '</p>';
                            echo '<p class="product-desc">From - To: ' . htmlspecialchars($row['Guide_area']) . '</p>';

                            echo '<p class="product-desc">City: ' . htmlspecialchars($row['location']) . '</p>';
